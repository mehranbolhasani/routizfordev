...
<rz-preview-marker :props='{{ json_encode( $props ) }}' inline-template>
            ...
            <div class="rz-col-6 rz-col-lg-12">
                ...
                <div class="rz-heading">
                    <label class="rz-ellipsis ">
                        {{ esc_html__( 'Marker Preview', 'routiz' ) }}
                    </label>
                </div>
                ...
                <div class="rz-prv rz-flex rz-flex-column rz-justify-center rz-no-select">
                    ...
                    <div v-if="type == 'image'" class="rz-prv-marker rz-prv-marker-image">
                        ...
                        <template v-else>
                            <p class="rz-prv-marker-warning rz-mb-0">@php esc_html_e( 'Upload marker image', 'routiz' ); @endphp</p>
                        </template>
                    </div>
                    ...
                    <div v-if="type == 'field'" class="rz-prv-marker rz-prv-marker-field" :class="{ 'rz-field-empty': ! field }">
                        ...
                        <template v-else>
                            @php esc_html_e( 'Select field', 'routiz' ); @endphp
                        </template>
                    </div>
