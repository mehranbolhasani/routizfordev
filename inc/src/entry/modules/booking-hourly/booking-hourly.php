...
namespace Routiz\Inc\Src\Entry\Modules\Booking_Hourly;
...
class Booking_Hourly extends Module {
    ...
    public function admin() {
        ...
        return array_merge( (array) $this->props, [
            ...
            'userdata' => $userdata,
            'checkin_date' => $checkin ? date_i18n( get_option('date_format') . ' ' . get_option('time_format'), $checkin ) : '-',
            'checkout_date' => $checkout ? date_i18n( get_option('date_format') . ' ' . get_option('time_format'), $checkout ) : '-',
